...
import ComponentData from "../../assets/JSON/FP_set5/Data.json";
...
const FP_Set5 = [
    {
        ...
        code: CodeSnippet1,
        output: <Question1 watchlist={ComponentData.watchlist} />,
        json: ComponentData.watchlist,
    },
    {
        qno: 2,
        question:
        ...
        output: <Question2 products={ComponentData.products} />,
        code: CodeSnippet2,
        json: ComponentData.products,
    },
    {
        qno: 3,
        question:
        ...
        output: <Question3 books={ComponentData.books} />,
        code: CodeSnippet3,
        json: ComponentData.books,
    },
    {
        qno: 4,
        question:
        ...
        output: <Question4 employees={ComponentData.employees} />,
        code: CodeSnippet4,
        json: ComponentData.employees,
    },
    {
        qno: 5,
        question:
        ...
        output: <Question5 cookbook={ComponentData.cookbook} />,
        code: CodeSnippet5,
        json: ComponentData.cookbook,
    },
    {
        qno: 6,
        question:
        ...
        output: <Question6 cars={ComponentData.cars} />,
        code: CodeSnippet6,
        json: ComponentData.cars,
    },
    {
        qno: 7,
        question:
        ...
        output: <Question7 students={ComponentData.students} />,
        code: CodeSnippet7,
        json: ComponentData.students,
    },
    {
        qno: 8,
        question:
        ...
        output: <Question8 movies={ComponentData.movies} />,
        code: CodeSnippet8,
        json: ComponentData.movies,
    },
    {
        qno: 9,
        question:
        ...
        output: <Question9 products={ComponentData.products} />,
        code: CodeSnippet9,
        json: ComponentData.products,
    },
    {
        ...
        output: <Question10 recipes={ComponentData.recipes} />,
        code: CodeSnippet10,
        json: ComponentData.recipes,
    },
];
export default FP_Set5;
